/****************************************************************************
** Meta object code from reading C++ file 'DataContainer.hpp'
**
...
#error "The header file 'DataContainer.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_DataContainer[] = {
    "DataContainer\0\0QString\0getCurrentDeviceName()\0"
    "getCurrentDeviceAddr()\0device_name\0"
    "setCurrentDeviceName(QString)\0device_addr\0"
    "setCurrentDeviceAddr(QString)\0"
};
...
void DataContainer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { QString _r = _t->getCurrentDeviceName();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = _r; }  break;
        case 1: { QString _r = _t->getCurrentDeviceAddr();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = _r; }  break;
        case 2: _t->setCurrentDeviceName((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->setCurrentDeviceAddr((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
