...
DataContainer::DataContainer()
{
    ...
    _tx_power_service_instance = -1;
    _rssi = 0;
    _proximity_indicator = -1;
    _client_proximity_handle = -1;
    _client_proximity_value_handle = -1;
    _proximity_monitoring_service_instance = -1;
}
...
uint16_t DataContainer::getClientProximityHandle()
{
    return _client_proximity_handle;
}

void DataContainer::setClientProximityHandle(uint16_t handle)
{
    _client_proximity_handle = handle;
}

uint16_t DataContainer::getClientProximityValueHandle()
{
    return _client_proximity_value_handle;
}

void DataContainer::setClientProximityValueHandle(uint16_t handle)
{
    _client_proximity_value_handle = handle;
}

void DataContainer::setProximityMonitoringServiceInstance(int instance)
{
    _proximity_monitoring_service_instance = instance;
}

int DataContainer::getProximityMonitoringServiceInstance()
{
    return _proximity_monitoring_service_instance;
}
